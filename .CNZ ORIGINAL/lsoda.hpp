...
public:
    ...
    /*
     ...
     hmin = rwork7
     */
    void lsoda(void (ODE::*f)(double, double *, double *, void *), int neq, double *y, double *t, double tout, int itol, double *rtol, double *atol,
     ...
     */
    void stoda( int neq, double *y, void (ODE::*f)(double, double *, double *, void *), void *_data )
    {
     ...
     */
    void prja( int neq, double *y, void (ODE::*f)(double, double *, double *, void *), void *_data )
    {
        int             i, ier, j;
     ...
     */
    void correction(int neq, double *y, void (ODE::*f)(double, double *, double *, void *), int *corflag, double pnorm, double *del, double *delp, double *told,
...
private:
    ...
    //  double rwork1, rwork5, rwork6, rwork7;
    //  int    neq;
    //  double atol[neq+1], rtol[neq+1], t, tout, y[neq+1];
    //  int    iwork1, iwork2, iwork5, iwork6, iwork7, iwork8, iwork9;
...
//            lsod.lsoda(&ODE::frhs, neq, y, &t, tout, itol, rtol, atol, itask, &istate, iopt, jt,
