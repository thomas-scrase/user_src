 ...
 *
 *
 *  Created by Mao-Tsuen Jeng on 9/7/10. Colleen Clancy Lab
 *  Copyright 2010 _UC Davis__. All rights reserved.
 *
 *
...
void integrate_rk2( void (*func)( double , double , double *, double * , SRUnit &), double * tspan, int sy0, double * y0, double dt, SRUnit & caunit);

// func : function that evaluate ydots ( 1st derivatives ).
...
void integrate_rk2( void (*func)( double , double , double *, double *, SRUnit &), double * tspan, int sy0, double * y0, double dt, SRUnit & caunit) {
	...
	//	func( y1,  ydot , Istim , currents, celltype, gendertype, gterm , dt );
	func( dt, t, y1, ydot, caunit );
	...
	//	func( y2, ydot , Istim , currents, celltype, gendertype, gterm , dt );
	func( dt, t, y2, ydot, caunit );
