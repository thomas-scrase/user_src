...
{	
	...
	public:
			...
			for(unsigned vec = 0; vec < DIM; vec++){
				...
				for(unsigned d = 0; d < DIM; d++){
					...
					for(unsigned l = 0; l < n_node; l++){
						...
						A(d, vec) += nodal_value(l, (this->min_index_storage_enrichment() + vec*DIM + d) )*psi[l];
					}
				}
			}
		}
		...
		void fill_in_contribution_to_residuals(Vector<double> &residuals)
		{
			...
			StorageEnrichmentEquations<DIM, DIM*DIM>::fill_in_contribution_to_residuals(residuals);
		}

		void fill_in_contribution_to_jacobian(Vector<double> &residuals,DenseMatrix<double> &jacobian)
		{
			AnisotropicPVDEquations<DIM>::fill_in_contribution_to_jacobian(residuals,jacobian);
			StorageEnrichmentEquations<DIM, DIM*DIM>::fill_in_contribution_to_jacobian(residuals,jacobian);
		}
	...
	// //Face Geometries
	template<unsigned DIM, unsigned NNODE_1D>
	class FaceGeometry<QAnisotropicWithVectPVDElement<DIM, DIM*DIM, NNODE_1D> >:
	...
	class FaceGeometry<QAnisotropicWithVectPVDElement<1, DIM*DIM, NNODE_1D> >:
