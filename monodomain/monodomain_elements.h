...
//Header file for Monodomain elements
...
class MonodomainEquations : public virtual FiniteElement
{
public:
 ...
 void operator=(const MonodomainEquations&) 
  {
   BrokenCopy::broken_assign("MonodomainEquations");
  }
 ...
 virtual inline unsigned u_index_monodomain() const {return 0;}
...
/// \short du/dt at local node n. 
 ...
 /// Pointer to Peclet number multipled by Strouhal number
 ...
 void fill_in_contribution_to_residuals(Vector<double> &residuals)
  {
   ...
   //a dummy matrix
   fill_in_generic_residual_contribution_monodomain(
...
protected:
 ...
 virtual double dshape_and_dtest_eulerian_at_knot_monodomain(
  const unsigned &ipt, 
  Shape &psi, 
  DShape &dpsidx,
  Shape &test, 
 ...
 virtual void fill_in_generic_residual_contribution_monodomain(
  Vector<double> &residuals, DenseMatrix<double> &jacobian, 
...
private:
 ...
 void output_fct(std::ostream &outfile, const unsigned &n_plot,
                 FiniteElement::SteadyExactSolutionFctPt 
                 exact_soln_pt)
  {MonodomainEquations<DIM>::output_fct(outfile,n_plot,exact_soln_pt);}
...
template<unsigned DIM, unsigned NNODE_1D>
double QMonodomainElement<DIM,NNODE_1D>::
 dshape_and_dtest_eulerian_at_knot_monodomain(
 const unsigned &ipt,
 Shape &psi, 
 DShape &dpsidx,
 Shape &test, 
