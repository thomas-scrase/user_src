#ifndef OOMPH_EXPLICIT_CNZ_ATRIA_MARKOVCHAIN_IKS_HEADER
#define OOMPH_EXPLICIT_CNZ_ATRIA_MARKOVCHAIN_IKS_HEADER
...
class ExplicitCNZAtriaMarkovChainIKs : public CellModelBase
{
public:
	ExplicitCNZAtriaMarkovChainIKs();
	...
	inline unsigned required_nodal_variables(const unsigned &cell_type=0){return 65;}
