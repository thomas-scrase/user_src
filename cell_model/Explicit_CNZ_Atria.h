#ifndef OOMPH_EXPLICIT_CNZ_ATRIA_HEADER
#define OOMPH_EXPLICIT_CNZ_ATRIA_HEADER
...
class ExplicitCNZAtria : public CellModelBase
{
public:
	ExplicitCNZAtria();
	...
	inline unsigned required_nodal_variables(const unsigned &cell_type=0){return 49;}
