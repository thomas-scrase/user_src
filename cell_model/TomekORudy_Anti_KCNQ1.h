#ifndef OOMPH_IMPLICIT_TOMEKORUDY_VENT_ANTI_KCNQ1_HEADER
#define OOMPH_IMPLICIT_TOMEKORUDY_VENT_ANTI_KCNQ1_HEADER
...
namespace oomph{
	...
	class TomekORudyVentAntiKCNQ1 : public CellModelBase
	{
	public:
		TomekORudyVentAntiKCNQ1();
