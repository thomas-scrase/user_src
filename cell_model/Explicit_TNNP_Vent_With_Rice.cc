...
inline bool ExplicitTNNPVentWithRice::return_initial_state_variable(const unsigned &n, double &v, const unsigned &cell_type){
	...
	{
	//Cell Type 100
	{9.48162e-05, 3.03525, 0.000202384, 8.05137, 136.964, 0.00155309, 0.75751, 0.757259, 0, 1, 0.00315285, 0.999998, 2.23544e-08, 3.16832e-05, 0.979515, 0.999521, 0.999975, 0.989472, 0.000291621, 0.425051, 0.998551, 0.000221463, 0.000761795, 0.000375546, 9.00317e-05, 0.999772, 3.22574e-05, 0.000171593, 2.19947, 0.00700006, 3.21296e-08, 0.0205139, 0.17339, -0.00158723},
	//Cell Type 101
	{0.000107514, 3.70656, 0.000222606, 8.48193, 135.835, 0.00171251, 0.745116, 0.744476, 0, 1, 0.00330757, 0.999996, 2.41353e-08, 3.3686e-05, 0.967199, 0.999488, 0.999965, 0.987972, 0.000318226, 0.403233, 0.997317, 0.000659563, 0.00117496, 0.000575796, 0.000273157, 0.99966, 4.81499e-05, 0.000256181, 2.19921, 0.0070001, 5.58389e-08, 0.023198, 0.192184, -0.0023722},
	//Cell Type 102
	{9.90921e-05, 3.2338, 0.000209902, 8.81018, 135.001, 0.0017206, 0.744511, 0.744102, 0, 1, 0.00327015, 0.65201, 2.42244e-08, 3.37859e-05, 0.977341, 0.999487, 0.999972, 0.989015, 0.000319571, 0.407727, 0.998216, 0.000328376, 0.00088403, 0.000435047, 0.000136166, 0.999738, 3.71479e-05, 0.000197613, 2.19939, 0.00700007, 3.78458e-08, 0.0214192, 0.179807, -0.00182853},
	//Cell Type 103
	{9.8968e-05, 3.21785, 0.000208811, 9.05708, 134.173, 0.00176749, 0.741012, 0.740632, 0, 1, 0.00329174, 0.999998, 2.47413e-08, 3.43614e-05, 0.979594, 0.999477, 0.999974, 0.989382, 0.000327353, 0.405002, 0.99843, 0.000245524, 0.000818418, 0.000403396, 0.000102372, 0.999739, 3.69795e-05, 0.000196706, 2.19939, 0.00700006, 3.59041e-08, 0.0213928, 0.179611, -0.00182015},
	//Cell Type 104
	{0.000109918, 3.81239, 0.000226331, 9.10696, 133.439, 0.00186542, 0.733875, 0.733128, 0, 1, 0.00339888, 0.999996, 2.58129e-08, 3.55465e-05, 0.967707, 0.999458, 0.999965, 0.987961, 0.00034355, 0.390844, 0.997229, 0.000674337, 0.00121626, 0.000596158, 0.000284009, 0.999635, 5.15933e-05, 0.000274497, 2.19915, 0.0070001, 5.91844e-08, 0.0237044, 0.195636, -0.00254244},
	//Cell Type 105
	{0.000100855, 3.30963, 0.000213242, 9.19457, 132.851, 0.00186691, 0.733774, 0.7333, 0, 1, 0.00335981, 0.647914, 2.58288e-08, 3.55644e-05, 0.977432, 0.999458, 0.999972, 0.988975, 0.000343797, 0.395611, 0.998129, 0.000346202, 0.000923847, 0.000454625, 0.000145877, 0.999722, 3.92833e-05, 0.00020897, 2.19935, 0.00700007, 3.95529e-08, 0.0217919, 0.182418, -0.00193392}
	};
	if(n>=0 && n<34 && cell_type>=100 && cell_type<106){v = Vars[cell_type-100][n]; return true;}
	else{return false;}
	// switch(n){
	// 	case 0 : v = 0.00007;
	// 			break;
	...
	// 	case 25 : v = 0.97;  // N
 //                break;
 //        case 26 : v = 0.01;   // XBprer
 //                break;
 //        case 27 : v = 0.01;   // XBpostr
 //                break;
 //        case 28 : v = SLset;   // SL
 //                break;
 //        case 29 : v = x_0;   // xXBpostr
 //                break;
 //        case 30 : v = 0.0;   // xXBprer
 //                break;
 //        case 31 : v = 0.01447254;   // TropCaL
 //                break;
 //        case 32 : v = 0.2320947;   // TropCaH
 //                break;
 //        case 33 : v = 0.0;   // intergral of force, normallised
