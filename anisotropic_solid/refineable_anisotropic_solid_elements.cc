...
//====================================================================
/// Residuals for Refineable QAnisotropicPVDElements
//====================================================================
template<unsigned DIM>
void RefineableAnisotropicPVDEquations<DIM>::
                                              ...
                                              const unsigned& flag)
{
 ...
 if (this->Anisotropic_constitutive_law_pt->requires_incompressibility_constraint())
  {
   throw OomphLibError(
    "RefineableAnisotropicPVDEquations cannot be used with incompressible constitutive laws.",
...
//=======================================================================
template<unsigned DIM>
void RefineableAnisotropicPVDEquationsWithPressure<DIM>::get_mass_matrix_diagonal(
...
//==========================================================================
template<unsigned DIM>
void RefineableAnisotropicPVDEquationsWithPressure<DIM>::
 ...
 for(unsigned ipt=0;ipt<n_intpt;ipt++)
  {
   ...
   if(this->Incompressible)
    {
     this->get_stress(g,G,A,sigma_dev,Gup,detG);
     ...
     if((flag==1) || (flag==3))
      {
       ...
       //respect to G
       this->get_d_stress_dG_upper(g,G,A,sigma,detG,interpolated_solid_p,
   ...
   // the generalised dilatation and the inverse bulk modulus.
    ...
    {
     this->get_stress(g,G,A,sigma_dev,Gup,gen_dil,inv_kappa);
...
template class RefineableAnisotropicPVDEquationsWithPressure<2>;
template class RefineableAnisotropicPVDEquationsWithPressure<3>;
