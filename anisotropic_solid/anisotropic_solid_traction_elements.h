...
#ifndef OOMPH_ANISOTROPIC_SOLID_TRACTION_ELEMENTS_HEADER
#define OOMPH_ANISOTROPIC_SOLID_TRACTION_ELEMENTS_HEADER
...
/// elements
//=======================================================================
namespace AnisotropicSolidTractionElementHelper
 {
...
class AnisotropicSolidTractionElement : public virtual FaceGeometry<ELEMENT>, 
...
public:
 ...
 AnisotropicSolidTractionElement(FiniteElement* const &element_pt, 
  ...
  { 
   ...
   // Zero traction
   Traction_fct_pt=&AnisotropicSolidTractionElementHelper::Zero_traction_fct;
...
//=====================================================================
template<class ELEMENT>
void AnisotropicSolidTractionElement<ELEMENT>::traction(const Vector<double>& s, 
                                             Vector<double>& traction)
{
 unsigned n_dim = this->nodal_dimension();
...
//=====================================================================
/// Return the residuals for the AnisotropicSolidTractionElement equations
//=====================================================================
template<class ELEMENT>
void AnisotropicSolidTractionElement<ELEMENT>::
 ...
 for(unsigned ipt=0;ipt<n_intpt;ipt++)
  {
   ...
   switch(n_dim)
    ...
    default:
     throw 
      OomphLibError("Wrong dimension in AnisotropicSolidTractionElement",
                    "AnisotropicSolidTractionElement::fill_in_contribution_to_residuals()",
                    OOMPH_EXCEPTION_LOCATION);
    }
...
//======================================================================
template <class ELEMENT>
class RefineableAnisotropicSolidTractionElement : 
public virtual AnisotropicSolidTractionElement<ELEMENT>, 
 public virtual NonRefineableSolidElementWithHangingNodes
{
  public:
 
 ///Constructor, which takes a "bulk" element and the face index
 RefineableAnisotropicSolidTractionElement(FiniteElement* const &element_pt, 
                                const int &face_index) : 
 // we're calling this from the constructor of the refineable version.
 AnisotropicSolidTractionElement<ELEMENT>(element_pt, face_index,true)
  {}
 
 /// Destructor should not delete anything
 ~RefineableAnisotropicSolidTractionElement() {}
...
//============================================================================
template<class ELEMENT>
void RefineableAnisotropicSolidTractionElement<ELEMENT>::
refineable_fill_in_contribution_to_residuals_solid_traction(
 ...
 { 
  ...
  if (n_position_type!=1)
   {
    throw OomphLibError(
     "RefineableAnisotropicSolidTractionElement only works for n_position_type=1",
     OOMPH_CURRENT_FUNCTION,
     OOMPH_EXCEPTION_LOCATION);
   }
#endif
  ...
  for(unsigned ipt=0;ipt<n_intpt;ipt++)
   ...
   switch(n_dim)
    ...
    default:
     throw OomphLibError(
      "Wrong dimension in RefineableAnisotropicSolidTractionElement",
      OOMPH_CURRENT_FUNCTION,
      OOMPH_EXCEPTION_LOCATION);
    }
...
/////////////////////////////////////////////////////////////////////////
 ...
 //=========================================================================
 /// AnisotropicSolidTractionElement "upgraded" to a FSIWallElement (and thus, 
 ...
 class FSIAnisotropicSolidTractionElement : 
  public virtual AnisotropicSolidTractionElement<ELEMENT>, 
  public virtual FSIWallElement
{
 ...
 /// FSIAnisotropicSolidTractionElement::set_normal_pointing_out_of_fluid()
 /// Constructor for GeomObject is called explicitly because
 /// of virtual inheritance!
 FSIAnisotropicSolidTractionElement(FiniteElement* const &element_pt, 
                         const int &face_index,
                         const bool& called_from_refineable_constructor=false): 
 AnisotropicSolidTractionElement<ELEMENT>(element_pt,face_index, 
 ...
 ~FSIAnisotropicSolidTractionElement(){}
 ...
 virtual void fill_in_contribution_to_jacobian(Vector<double> &residuals,
  ...
  AnisotropicSolidTractionElement<ELEMENT>::
...
//=============================================================================
 template<class ELEMENT, unsigned DIM>
void FSIAnisotropicSolidTractionElement<ELEMENT,DIM>::get_dof_numbers_for_unknowns(
 std::list<std::pair<unsigned long,unsigned> >& dof_lookup_list) const
{
...
//=========================================================================
/// RefineableAnisotropicSolidTractionElement "upgraded" to a FSIWallElement (and thus, 
/// by inheritance, a GeomObject), so it can be used in FSI. 
/// The element is templated by the bulk solid element and 
/// the spatial (Eulerian) dimension of the bulk element.
//=========================================================================
template<class ELEMENT, unsigned DIM>
  class RefineableFSIAnisotropicSolidTractionElement : 
  public virtual RefineableAnisotropicSolidTractionElement<ELEMENT>, 
  public virtual FSIAnisotropicSolidTractionElement<ELEMENT,DIM>, 
  public virtual FSIWallElement
{
 ...
 /// Constructor for GeomObject is called explicitly because
 /// of virtual inheritance!
  RefineableFSIAnisotropicSolidTractionElement(FiniteElement* const &element_pt, 
                                    const int &face_index) : 
  AnisotropicSolidTractionElement<ELEMENT>(element_pt,face_index,true),
   RefineableAnisotropicSolidTractionElement<ELEMENT>(element_pt,face_index),
   FSIAnisotropicSolidTractionElement<ELEMENT,DIM>(element_pt,face_index,true)
   {}
 
 /// \short Destructor: empty
 ~RefineableFSIAnisotropicSolidTractionElement(){}
 ...
 virtual void fill_in_contribution_to_jacobian(Vector<double> &residuals,
  ...
  {
  //Call the underlying element's jacobian function
  RefineableAnisotropicSolidTractionElement<ELEMENT>::
   fill_in_contribution_to_jacobian(residuals,jacobian);
  //Add the contribution of the external load data by finite differences
  this->fill_in_jacobian_from_external_interaction_by_fd(jacobian);
  }
