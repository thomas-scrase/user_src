...
//========================================================================
/// Class for Refineable AnisotropicPVD equations
//========================================================================
 ...
 void get_Z2_flux(const Vector<double>& s, Vector<double>& flux) 
{
 ...
 void further_build()
  {
   RefineableAnisotropicPVDEquations<DIM>* cast_father_element_pt
    = dynamic_cast<RefineableAnisotropicPVDEquations<DIM>*>
...
//========================================================================
/// Class for refineable QAnisotropicPVDElement elements
//========================================================================
template<unsigned DIM, unsigned NNODE_1D>
class RefineableQAnisotropicPVDElement : public virtual QAnisotropicPVDElement<DIM,NNODE_1D>, 
...
public:
 ...
 /// \short Constructor: 
 RefineableQAnisotropicPVDElement() : 
 ...
 unsigned nvertex_node() const
  {return QAnisotropicPVDElement<DIM,NNODE_1D>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {return QAnisotropicPVDElement<DIM,NNODE_1D>::vertex_node_pt(j);}
...
//==============================================================
/// FaceGeometry of the 2D RefineableQAnisotropicPVDElement elements
//==============================================================
template<unsigned NNODE_1D>
class FaceGeometry<RefineableQAnisotropicPVDElement<2,NNODE_1D> >:
...
//==============================================================
/// FaceGeometry of the FaceGeometry of the 2D RefineableQAnisotropicPVDElement 
//==============================================================
template<unsigned NNODE_1D>
class FaceGeometry<FaceGeometry<RefineableQAnisotropicPVDElement<2,NNODE_1D> > >:
...
//==============================================================
/// FaceGeometry of the 3D RefineableQAnisotropicPVDElement elements
//==============================================================
template<unsigned NNODE_1D>
class FaceGeometry<RefineableQAnisotropicPVDElement<3,NNODE_1D> >:
...
//==============================================================
/// FaceGeometry of the FaceGeometry of the 3D RefineableQAnisotropicPVDElement
//==============================================================
template<unsigned NNODE_1D>
class FaceGeometry<FaceGeometry<RefineableQAnisotropicPVDElement<3,NNODE_1D> > >:
public virtual SolidQElement<1,NNODE_1D>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
//===========================================================================
template<unsigned DIM>
class RefineableAnisotropicPVDEquationsWithPressure : 
...
/// Number of continuously interpolated values: 0 (pure solid problem)
 ...
 void further_build()
  {
   RefineableAnisotropicPVDEquationsWithPressure<DIM>* cast_father_element_pt
    = dynamic_cast<RefineableAnisotropicPVDEquationsWithPressure<DIM>*>
    (this->father_element_pt());
...
//===========================================================================
template<unsigned DIM>
class RefineableQAnisotropicPVDElementWithPressure : 
...
public virtual RefineableSolidQElement<DIM>
{
 ...
 /// \short Constructor: 
 RefineableQAnisotropicPVDElementWithPressure() :
 ...
 /// \short Number of vertex nodes in the element
 unsigned nvertex_node() const
  {return QAnisotropicPVDElementWithPressure<DIM>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {return QAnisotropicPVDElementWithPressure<DIM>::vertex_node_pt(j);}
...
//======================================================================
///FaceGeometry of the 2D RefineableQAnisotropicPVDElementWithPressure
//=======================================================================
template<>
class FaceGeometry<RefineableQAnisotropicPVDElementWithPressure<2> >:
...
//===========================================================================
///FaceGeometry of the FaceGeometry of the 2D RefineableQAnisotropicPVDElementWithPressure
//============================================================================ 
template<>
class FaceGeometry<FaceGeometry<RefineableQAnisotropicPVDElementWithPressure<2> > >:
public virtual PointElement
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
//===================================================================
template<>
inline void RefineableQAnisotropicPVDElementWithPressure<2>::
 ...
 for (unsigned ison=0;ison<4;ison++)
  {
   ...
   centre_solid_p[ison] = 
    dynamic_cast<RefineableQAnisotropicPVDElementWithPressure<2>*>
...
//=============================================================
template<>
inline void RefineableQAnisotropicPVDElementWithPressure<2>::further_build()
{
 RefineableAnisotropicPVDEquationsWithPressure<2>::further_build();
 ...
 // South west son
   ...
   RefineableQAnisotropicPVDElementWithPressure<2>* cast_father_element_pt=
    dynamic_cast<RefineableQAnisotropicPVDElementWithPressure<2>*>(father_el_pt);
...
//===============================================================
template<>
inline void RefineableQAnisotropicPVDElementWithPressure<3>::
rebuild_from_sons(Mesh* &mesh_pt) 
{
...
//=================================================================
template<>
inline void RefineableQAnisotropicPVDElementWithPressure<3>::further_build()

 {
  RefineableAnisotropicPVDEquationsWithPressure<3>::further_build();
  ...
  using namespace OcTreeNames;
   ...
   // Pressure value in father element
   RefineableQAnisotropicPVDElementWithPressure<3>* cast_father_element_pt=
    dynamic_cast<RefineableQAnisotropicPVDElementWithPressure<3>*>(father_el_pt);
...
//=========================================================================
///FaceGeometry of the 3D RefineableQAnisotropicPVDElementWithPressure
//========================================================================
template<>
class FaceGeometry<RefineableQAnisotropicPVDElementWithPressure<3> >:
...
//========================================================================
///FaceGeometry of the FaceGeometry of the 3D RefineableQAnisotropicPVDElementWithPressure
//========================================================================== 
template<>
class FaceGeometry<FaceGeometry<RefineableQAnisotropicPVDElementWithPressure<3> > >:
public virtual SolidQElement<1,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
//===========================================================================
template<unsigned DIM>
class RefineableQAnisotropicPVDElementWithContinuousPressure : 
...
public virtual RefineableSolidQElement<DIM>
{
 ...
 /// \short Constructor:
 RefineableQAnisotropicPVDElementWithContinuousPressure() :
...
/// \short Number of vertex nodes in the element
 unsigned nvertex_node() const
  {return QAnisotropicPVDElementWithContinuousPressure<DIM>::nvertex_node();}

 /// \short Pointer to the j-th vertex node in the element
 Node* vertex_node_pt(const unsigned& j) const
  {
   return QAnisotropicPVDElementWithContinuousPressure<DIM>::vertex_node_pt(j);
  }
...
//=========================================================================
///FaceGeometry of the 2D RefineableQAnisotropicPVDElementWithContinuousPressure elements
//=========================================================================
template<>
class FaceGeometry<RefineableQAnisotropicPVDElementWithContinuousPressure<2> >:
 public virtual SolidQElement<1,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
class FaceGeometry<FaceGeometry<
 RefineableQAnisotropicPVDElementWithContinuousPressure<2> > >:
 public virtual PointElement
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
//=========================================================================
///FaceGeometry of the 3D RefineableQAnisotropicPVDElementWithContinuousPressure
//=========================================================================
template<>
class FaceGeometry<RefineableQAnisotropicPVDElementWithContinuousPressure<3> >:
 public virtual SolidQElement<2,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
...
///RefineableQAnisotropicPVDElementWithContinuousPressue
//=========================================================================
template<>
class FaceGeometry<FaceGeometry<
 RefineableQAnisotropicPVDElementWithContinuousPressure<3> > >:
public virtual SolidQElement<1,3>
{
  public:
 //Make sure that we call the constructor of the SolidQElement
