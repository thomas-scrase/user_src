...
//LIC// 
//LIC//====================================================================
//Header file for general anisotropic solid mechanics elements
...
/// Combines a few generic functions that are shared by  AnisotropicPVDEquations
/// and  AnisotropicPVDEquationsWithPressure.
//=======================================================================
 template <unsigned DIM>
  class AnisotropicPVDEquationsBase : public virtual SolidFiniteElement
  {
    private:
   ...
   AnisotropicPVDEquationsBase() :  Isotropic_growth_fct_pt(0),
   ...
   IsotropicGrowthFctPt& isotropic_growth_fct_pt() {return Isotropic_growth_fct_pt;}
   
   /// Access function: Pointer to pre-stress function
   PrestressFctPt& prestress_fct_pt() {return Prestress_fct_pt;}

   /// Access function: Pointer to isotropic growth function (const version)
   IsotropicGrowthFctPt isotropic_growth_fct_pt() const {return Isotropic_growth_fct_pt;}
   ...
   /// the member function
   /// - \c AnisotropicPVDEquationsBase<DIM>::
   ...
   static void pin_redundant_nodal_solid_pressures(
    const Vector<GeneralisedElement*>& element_pt)
    {
     ...
     for(unsigned e=0;e<n_element;e++)
      {
       dynamic_cast<AnisotropicPVDEquationsBase<DIM>*>(element_pt[e])->
...
//=======================================================================
template <unsigned DIM>
class AnisotropicPVDEquations : public virtual AnisotropicPVDEquationsBase<DIM>
{

    public:
   
   /// \short  Constructor
   AnisotropicPVDEquations(){}
     ...
     if(this->Anisotropic_constitutive_law_pt==0)
      {
       ...
       std::string error_message =
        "Elements derived from AnisotropicPVDEquations must have a constitutive law:\n";
       error_message +=
...
//============================================================================
 template<unsigned DIM, unsigned NNODE_1D>
  class QAnisotropicPVDElement : public virtual SolidQElement<DIM,NNODE_1D>,
  public virtual AnisotropicPVDEquations<DIM>
  {
    public:
   
   /// Constructor, there are no internal data points
   QAnisotropicPVDElement() : SolidQElement<DIM,NNODE_1D>(), AnisotropicPVDEquations<DIM>() { }
   ...
   /// Output function
   void output(std::ostream &outfile, const unsigned &n_plot)
    {AnisotropicPVDEquations<DIM>::output(outfile,n_plot);}
   ...
   /// C-style output function
   void output(FILE* file_pt, const unsigned &n_plot)
    {AnisotropicPVDEquations<DIM>::output(file_pt,n_plot);}
...
//============================================================================
 template<unsigned DIM>
  class HermiteAnisotropicPVDElement : public virtual SolidQHermiteElement<DIM>, 
  public virtual AnisotropicPVDEquations<DIM>
  {
   ...
   /// Constructor, there are no internal data points
   HermiteAnisotropicPVDElement() : SolidQHermiteElement<DIM>(), 
...
//==========================================================
/// AnisotropicPVDElementWithContinuousPressure upgraded to become projectable
//==========================================================
 template<class AnisotropicPVD_ELEMENT>
 class ProjectableAnisotropicPVDElement : 
  public virtual ProjectableElement<AnisotropicPVD_ELEMENT>
 {
 ...
 public:
  ...
  ProjectableAnisotropicPVDElement(){}
  

  /// \short Specify the values associated with field fld. 
  /// The information is returned in a vector of pairs which comprise 
  /// the Data object and the value within it, that correspond to field fld. 
  /// In the underlying AnisotropicPVD elements there are no field values
...
//============================================================================
template<unsigned DIM>
class QAnisotropicPVDElementWithPressure : public virtual SolidQElement<DIM,3>, 
                                public virtual AnisotropicPVDEquationsWithPressure<DIM>
{
 ...
 QAnisotropicPVDElementWithPressure() : SolidQElement<DIM,3>(), 
 ...
 /// AnisotropicPVDEquationsWithPressure output function
 void output(std::ostream &outfile, const unsigned &n_plot)
  {AnisotropicPVDEquationsWithPressure<DIM>::output(outfile,n_plot);}

 
 /// C-style Generic FiniteElement output function
 void output(FILE* file_pt) {FiniteElement::output(file_pt);}

 /// C-style AnisotropicPVDEquationsWithPressure output function
 void output(FILE* file_pt, const unsigned &n_plot)
  {AnisotropicPVDEquationsWithPressure<DIM>::output(file_pt,n_plot);}

};
 

//=====================================================================
/// Pressure shape functions for 2D QAnisotropicPVDElementWithPressure elements
//=====================================================================
template<>
inline void  QAnisotropicPVDElementWithPressure<2>::solid_pshape(const Vector<double> &s, 
                                                      Shape &psi) const
{
 psi[0] = 1.0;
 psi[1] = s[0];
...
//=====================================================================
/// Pressure shape functions for 3D QAnisotropicPVDElementWithPressure elements
//=====================================================================
template<>
inline void  QAnisotropicPVDElementWithPressure<3>::solid_pshape(const Vector<double> &s, 
                                                      Shape &psi) const
{
 psi[0] = 1.0;
 psi[1] = s[0];
...
//============================================================================
template<unsigned DIM>
class QAnisotropicPVDElementWithContinuousPressure : public virtual SolidQElement<DIM,3>,
                     public virtual AnisotropicPVDEquationsWithPressure<DIM>
{
  private:
...
public:
 ...
 /// Constructor
 QAnisotropicPVDElementWithContinuousPressure() : SolidQElement<DIM,3>(), 
  AnisotropicPVDEquationsWithPressure<DIM>() 
  { }
...
//===============================================================
/// Pressure shape functions for 2D QAnisotropicPVDElementWithContinuousPressure
/// elements
//===============================================================
template<>
inline void  QAnisotropicPVDElementWithContinuousPressure<2>::solid_pshape(
...
//===============================================================
/// Pressure shape functions for 3D QAnisotropicPVDElementWithContinuousPressure
/// elements
//===============================================================
template<>
inline void  QAnisotropicPVDElementWithContinuousPressure<3>::solid_pshape(
 const Vector<double> &s, Shape &psi) const
{
 //Local storage
...
//============================================================================
template<unsigned DIM, unsigned NNODE_1D>
 class TAnisotropicPVDElement : public virtual SolidTElement<DIM,NNODE_1D>,
 public virtual AnisotropicPVDEquations<DIM>,
 public virtual ElementWithZ2ErrorEstimator
{
 ...
 /// Constructor, there are no internal data points
  TAnisotropicPVDElement() : SolidTElement<DIM,NNODE_1D>(), AnisotropicPVDEquations<DIM>() { }
...
//============================================================================
template<unsigned DIM, unsigned NNODE_1D>
 class TAnisotropicPVDBubbleEnrichedElement : 
 ...
 public virtual ElementWithZ2ErrorEstimator
{
 ...
 /// Constructor, there are no internal data points
  TAnisotropicPVDBubbleEnrichedElement() : 
   SolidTBubbleEnrichedElement<DIM,NNODE_1D>(), AnisotropicPVDEquations<DIM>() { }
...
//=======================================================================
template <unsigned DIM>
class TAnisotropicPVDElementWithContinuousPressure : public virtual SolidTElement<DIM,3>,
 public virtual AnisotropicPVDEquationsWithPressure<DIM>,
 public virtual ElementWithZ2ErrorEstimator
{
  private:
...
public:
 ...
 /// Constructor
 TAnisotropicPVDElementWithContinuousPressure() : SolidTElement<DIM,3>(), 
  AnisotropicPVDEquationsWithPressure<DIM>() 
  { }
 

 /// Broken copy constructor
 TAnisotropicPVDElementWithContinuousPressure(
  const TAnisotropicPVDElementWithContinuousPressure<DIM>& dummy) 
  { 
   BrokenCopy::broken_copy("TAnisotropicPVDElementWithContinuousPressu");
  } 
...
//quite rightly, it shouts.
 /*void operator=(const TAnisotropicPVDElementWithContinuousPressure<DIM>&) 
  {
   BrokenCopy::broken_assign("TAnisotropicPVDElementWithContinuousPressure");
   }*/
...
//==========================================================================
template<>
inline unsigned TAnisotropicPVDElementWithContinuousPressure<2>::npres_solid() const
{return 3;}
...
//==========================================================================
template<>
inline unsigned TAnisotropicPVDElementWithContinuousPressure<3>::npres_solid() const
{return 4;}
...
//==========================================================================
template<>
inline void TAnisotropicPVDElementWithContinuousPressure<2>::solid_pshape(
 const Vector<double> &s, Shape &psi) const
{
 psi[0] = s[0];
 psi[1] = s[1];
...
//==========================================================================
template<>
inline void TAnisotropicPVDElementWithContinuousPressure<3>::solid_pshape(
 const Vector<double> &s, Shape &psi) const
{
 psi[0] = s[0];
 psi[1] = s[1];
...
//==========================================================
 template<class AnisotropicPVD_ELEMENT>
 class ProjectableAnisotropicPVDElementWithContinuousPressure : 
  public virtual ProjectableElement<AnisotropicPVD_ELEMENT>
 {
 ...
 public:
  ...
  /// \short Constructor [this was only required explicitly
  /// from gcc 4.5.2 onwards...]
  ProjectableAnisotropicPVDElementWithContinuousPressure(){}
  

  /// \short Specify the values associated with field fld. 
  /// The information is returned in a vector of pairs which comprise 
  /// the Data object and the value within it, that correspond to field fld. 
  /// In the underlying AnisotropicPVD elements  the pressures (the first 
...
//=======================================================================
 template<class ELEMENT>
 class FaceGeometry<ProjectableAnisotropicPVDElementWithContinuousPressure<ELEMENT> > 
  : public virtual FaceGeometry<ELEMENT>
 {
 public:
  FaceGeometry() : FaceGeometry<ELEMENT>() {}
...
//=======================================================================
 template<class ELEMENT>
 class FaceGeometry<FaceGeometry<
 ProjectableAnisotropicPVDElementWithContinuousPressure<ELEMENT> > >
 : public virtual FaceGeometry<FaceGeometry<ELEMENT> >
 {
   public:
   FaceGeometry() : FaceGeometry<FaceGeometry<ELEMENT> >() {}
