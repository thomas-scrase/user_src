...
//LIC//====================================================================
//Include guards
#ifndef OOMPH_ENTIRELY_COLLAPSIBLE_CHANNEL_DOMAIN_HEADER
#define OOMPH_ENTIRELY_COLLAPSIBLE_CHANNEL_DOMAIN_HEADER
...
//==================================================================
class EntirelyCollapsibleChannelDomain : public Domain
{
 ...
 public :
  ...
  EntirelyCollapsibleChannelDomain(
                          // const unsigned& nup, 
 ...
 /// Number of macro-elements along the channel
 unsigned nx()
  {
    return Nx;
  }
 ...
 /// \short Access to pointer to the geometric object that parametrises 
 /// the upper collapsible wall
 GeomObject*& u_wall_pt(){return U_Wall_pt;}


 /// \short Access to pointer to the geometric object that parametrises 
 /// the upper collapsible wall (const version)
 GeomObject* u_wall_pt() const {return U_Wall_pt;}


 /// \short Access to pointer to the geometric object that parametrises 
 /// the bottom collapsible wall
 GeomObject*& b_wall_pt(){return B_Wall_pt;}


 /// \short Access to pointer to the geometric object that parametrises 
 /// the bottom collapsible wall (const version)
 GeomObject* b_wall_pt() const {return B_Wall_pt;}
...
void macro_element_boundary(const unsigned& t,
 ...
 /// \short Northern boundary of the macro element
 void r_N(const unsigned& t, 
          const Vector<double>& zeta,
          Vector<double>& r, 
          const unsigned& imacro);

 /// \short Western boundary of the macro element imacro
 void r_W(const unsigned& t, 
          const Vector<double>& zeta,
          Vector<double>& r, 
          const unsigned& imacro);

 /// \short Southern boundary of the macro element imacro
 void r_S(const unsigned& t, 
          const Vector<double>& zeta,
          Vector<double>& r, 
          const unsigned& imacro );
 
 /// \short Eastern boundary of the macro element imacro
 void r_E(const unsigned& t, 
          const Vector<double>& zeta,
          Vector<double>& r, 
          const unsigned& imacro );
...
/// Domain base class.
//=================================================================
void EntirelyCollapsibleChannelDomain::macro_element_boundary(const unsigned& t,
                                                      const unsigned& imacro,
                                                      const unsigned& idirect,
                                                      const Vector<double>& zeta,
                                                      Vector<double>& r)
{
 using namespace QuadTreeNames;
   ...
   OomphLibWarning(
    ...
    "EntirelyCollapsibleChannelDomain::macro_element_boundary(...)",
...
// //===========================================================================
// void EntirelyCollapsibleChannelDomain::r_W_straight(const Vector<double>& zeta,
//                                             Vector<double>& r, 
//                                             const unsigned& imacro,
//                                             const unsigned& part)
// {                                   
...
//===========================================================================
// void EntirelyCollapsibleChannelDomain::r_E_straight(const Vector<double>& zeta,
//                                             Vector<double>& r, 
//                                             const unsigned& imacro,
//                                             const unsigned& part)
// {                                   
...
//==========================================================================
// void EntirelyCollapsibleChannelDomain::r_N_straight(const Vector<double>& zeta,
//                                             Vector<double>& r, 
//                                             const unsigned& imacro,
//                                             const unsigned& part)
// {                                   
...
/// part=0 in the left part, part=1 in the right part
//=========================================================================
// void EntirelyCollapsibleChannelDomain::r_S_straight(const Vector<double>& zeta,
//                                             Vector<double>& r, 
//                                             const unsigned& imacro,
//                                             const unsigned& part )
// {                                   
...
// //========================================================================
//  void EntirelyCollapsibleChannelDomain::r_W_collapsible(const unsigned& t, 
//                                                 const Vector<double>& zeta,
//                                                 Vector<double>& r, 
//                                                 const unsigned& imacro)
// {                                   
...
// /// channel; \f$ \zeta \in [-1,1] \f$
// //=========================================================================
// void EntirelyCollapsibleChannelDomain::r_E_collapsible(const unsigned& t, 
//                                                const Vector<double>& zeta,
//                                                Vector<double>& r, 
//                                                const unsigned& imacro)
// {                                   
...
// /// channel; \f$ \zeta \in [-1,1] \f$
// //==========================================================================
// void EntirelyCollapsibleChannelDomain::r_N_collapsible(const unsigned& t, 
//                                                const Vector<double>& zeta,
//                                                Vector<double>& r, 
//                                                const unsigned& imacro)
// {                                   
...
// /// channel; \f$ \zeta \in [-1,1] \f$
// //========================================================================
// void EntirelyCollapsibleChannelDomain::r_S_collapsible(const unsigned& t, 
//                                                const Vector<double>& zeta,
//                                                Vector<double>& r, 
//                                                const unsigned& imacro)
// {                                   
...
/// channel; \f$ \zeta \in [-1,1] \f$.
//========================================================================
 void EntirelyCollapsibleChannelDomain::r_W(const unsigned& t, 
                                            const Vector<double>& zeta,
                                            Vector<double>& r, 
                                            const unsigned& imacro)
{                                   
 ...
 // unsigned x=unsigned(imacro%(Nup+Ncollapsible+Ndown));
 // unsigned y=unsigned(double(imacro)/double(Nup+Ncollapsible+Ndown));
 unsigned x=unsigned(imacro%Nx);
 unsigned y=unsigned(double(imacro)/double(Nx));
 ...
 U_Wall_pt->position(t,xi,r_u_wall);
 // Position vector on bottom wall:
 Vector<double> r_b_wall(2);
 B_Wall_pt->position(t,xi,r_b_wall);
 ...
 // x-cooordinate -- straight line from bottom wall to top wall
 // wall to moving position on the top wall
 // r[0]=Lup+xi[0]+(r_wall[0]-(xi[0]+Lup))*fract;
 r[0] = r_b_wall[0] /*+ xi[0]*/ + (r_u_wall[0]-r_u_wall[0])*fract;

  // y-coordinate
 // r[1]=r_wall[1]*fract;
 r[1]=r_b_wall[1] + (r_u_wall[1] - r_b_wall[1])*fract;
...
/// channel; \f$ \zeta \in [-1,1] \f$
//=========================================================================
void EntirelyCollapsibleChannelDomain::r_E(const unsigned& t, 
                                           const Vector<double>& zeta,
                                           Vector<double>& r, 
                                           const unsigned& imacro)
{                                   
 ...
 // wall to moving position on the top wall
 // r[0]=Lup+xi[0]+(r_wall[0]-(xi[0]+Lup))*fract;
 r[0] = r_b_wall[0] /*+ xi[0]*/ + (r_u_wall[0]-xi[0])*fract;
...
/// channel; \f$ \zeta \in [-1,1] \f$
//==========================================================================
void EntirelyCollapsibleChannelDomain::r_N(const unsigned& t, 
                                           const Vector<double>& zeta,
                                           Vector<double>& r, 
                                           const unsigned& imacro)
{                                   
 ...
 Vector<double> xi(1);
 // xi[0]=(double(x-Nup)+(0.5*(1.0+zeta[0])))*(Lcollapsible/double(Ncollapsible));
 xi[0]=(double(x)+(0.5*(1.0+zeta[0])))*(Lx/double(Nx));
...
/// channel; \f$ \zeta \in [-1,1] \f$
//========================================================================
void EntirelyCollapsibleChannelDomain::r_S(const unsigned& t, 
                                           const Vector<double>& zeta,
                                           Vector<double>& r, 
                                           const unsigned& imacro)
{                                   
