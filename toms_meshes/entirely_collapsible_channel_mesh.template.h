...
//LIC// 
//LIC//    Version 1.0; svn revision $LastChangedRevision: 1104 $
//LIC//
//LIC// $LastChangedDate: 2016-01-09 08:06:50 +0000 (Sat, 09 Jan 2016) $
//LIC// 
...
//LIC//====================================================================
//Include guards
#ifndef OOMPH_ENTIRELY_COLLAPSIBLE_CHANNEL_MESH_HEADER
#define OOMPH_ENTIRELY_COLLAPSIBLE_CHANNEL_MESH_HEADER
...
#include "entirely_collapsible_channel_domain.h"
...
class EntirelyCollapsibleChannelMesh : public SimpleRectangularQuadMesh<ELEMENT>
{
...
public:
 ...
 EntirelyCollapsibleChannelMesh(
                        // const unsigned& nup, 
                        ...
                        const double& lx,
                        const double& ly,
                        GeomObject* u_wall_pt,
                        GeomObject* b_wall_pt,
 ...
 /// Access function to GeomObject representing upper wall
 GeomObject*& u_wall_pt(){return U_Wall_pt;}

 /// Access function to GeomObject representing upper wall
 GeomObject*& b_wall_pt(){return B_Wall_pt;}

 /// Access function to domain
 EntirelyCollapsibleChannelDomain* domain_pt(){return Domain_pt;}
 ...
 /// used in underlying EntirelyCollapsibleChannelDomain. Virtual
 ...
 virtual EntirelyCollapsibleChannelDomain::BLSquashFctPt& bl_squash_fct_pt()
  { 
 ...
 /// the mesh near the walls. Default trivial mapping (the identity)
 /// leaves vertical nodal positions unchanged. Mapping is
 /// used in underlying EntirelyCollapsibleChannelDomain. Const version.
 EntirelyCollapsibleChannelDomain::BLSquashFctPt bl_squash_fct_pt() const
  {
   return Domain_pt->bl_squash_fct_pt();
  }
 ...
 /// versions of this mesh where it doesn't make any sense
 /// to provide the bl_squash_fct after the mesh has been built).
 virtual EntirelyCollapsibleChannelDomain::AxialSpacingFctPt& axial_spacing_fct_pt()
  {
...
protected:
 ...
 /// Pointer to domain
 EntirelyCollapsibleChannelDomain* Domain_pt;
 ...
 /// Number of element columns down channel
 unsigned Nx;
...
//====================================================================
template <class ELEMENT>
class RefineableEntirelyCollapsibleChannelMesh :
 public virtual EntirelyCollapsibleChannelMesh<ELEMENT>,
...
public :
 ...
 RefineableEntirelyCollapsibleChannelMesh(
                                // const unsigned& nup, 
                                // const unsigned& ncollapsible, 
                                // const unsigned& ndown, 
                                // const unsigned& ny, 
                                ...
                                GeomObject* b_wall_pt,
                                TimeStepper* time_stepper_pt=&Mesh::Default_TimeStepper) :
 EntirelyCollapsibleChannelMesh<ELEMENT>(
...
//========================================================================
template<class ELEMENT>
class MacroElementNodeUpdateEntirelyCollapsibleChannelMesh : 
...
public: 
 ...
 MacroElementNodeUpdateEntirelyCollapsibleChannelMesh(
  // const unsigned& nup, 
  // const unsigned& ncollapsible, 
  // const unsigned& ndown, 
  // const unsigned& ny, 
   ...
   time_stepper_pt)
  {
   ...
   if (dynamic_cast<MacroElementNodeUpdateElementBase*>(el_pt)==0)
    {
     ...
     error_message 
      ...
      << "MacroElementNodeUpdateEntirelyCollapsibleChannelMesh needs" 
   ...
   for(unsigned i=0;i<n_element;i++)
    {
     ...
     // There's 2 GeomObjects
     Vector<GeomObject*> geom_object_pt(2);
     geom_object_pt[0] = this->U_Wall_pt;
     geom_object_pt[1] = this->B_Wall_pt;
   ...
   // Add the geometric object(s) for the walls to the mesh's storage
   Vector<GeomObject*> geom_object_pt(2);
   geom_object_pt[0] = this->U_Wall_pt;
   geom_object_pt[1] = this->B_Wall_pt;
 ...
 virtual ~MacroElementNodeUpdateEntirelyCollapsibleChannelMesh(){}
...
//========================================================================
template<class ELEMENT>
class MacroElementNodeUpdateRefineableEntirelyCollapsibleChannelMesh : 
 public virtual MacroElementNodeUpdateEntirelyCollapsibleChannelMesh<ELEMENT>, 
...
public: 
 ...
 /// geometric object that represents the wall and pointer to
 /// timestepper (defaults to Steady).
 MacroElementNodeUpdateRefineableEntirelyCollapsibleChannelMesh(
  // const unsigned& nup, 
  // const unsigned& ncollapsible, 
  // const unsigned& ndown, 
  // const unsigned& ny, 
  ...
  EntirelyCollapsibleChannelMesh<ELEMENT>(
   ...
   // time_stepper_pt
    ...
    u_wall_pt, b_wall_pt,
    time_stepper_pt),
  MacroElementNodeUpdateEntirelyCollapsibleChannelMesh<ELEMENT>(
   // nup, ncollapsible, ndown, ny,
   // lup, lcollapsible, ldown, ly,
   // wall_pt,
   // time_stepper_pt
 ...
 /// \short Destructor: empty
 virtual ~MacroElementNodeUpdateRefineableEntirelyCollapsibleChannelMesh(){}
...
//========start_of_algebraic_entirely_collapsible_channel_mesh==============
/// Collapsible channel mesh with algebraic node update
//=================================================================
template<class ELEMENT>
class AlgebraicEntirelyCollapsibleChannelMesh : 
  public virtual EntirelyCollapsibleChannelMesh<ELEMENT>,
...
public: 
 ...
 /// GeomObject that defines the collapsible segment and pointer to 
 /// TimeStepper (defaults to the default timestepper, Steady). 
 AlgebraicEntirelyCollapsibleChannelMesh(
                                 //  const unsigned& nup, 
                                 // const unsigned& ncollapsible, 
                                 // const unsigned& ndown, 
                                 // const unsigned& ny, 
                                  ...
                                  )
  {
   ...
   AlgebraicMesh::add_geom_object_list_pt(u_wall_pt);
   AlgebraicMesh::add_geom_object_list_pt(b_wall_pt);
 ...
 /// \short Destructor: empty
 virtual ~AlgebraicEntirelyCollapsibleChannelMesh(){}
 ...
 AlgebraicEntirelyCollapsibleChannelMesh(
  ...
  // const double& ly,
  // GeomObject* wall_pt,
  // EntirelyCollapsibleChannelDomain::BLSquashFctPt bl_squash_function_pt,
  // TimeStepper* time_stepper_pt=
  // &Mesh::Default_TimeStepper
  const unsigned& nx,
  const unsigned& ny,
                                  ...
                                  )
  {
   ...
   EntirelyCollapsibleChannelMesh<ELEMENT>::node_update();
 ...
 /// the mesh near the walls. Default trivial mapping (the identity)
 /// leaves vertical nodal positions unchanged. Mapping is
 /// used in underlying EntirelyCollapsibleChannelDomain. Broken function
 /// that overloads the version in the EntirelyCollapsibleChannelDomain.
 /// It does not make sense to specify the function pointer
 /// after the mesh has been set up!
 EntirelyCollapsibleChannelDomain::BLSquashFctPt& bl_squash_fct_pt()
  {
   std::ostringstream error_message;
   error_message 
    ...
    std::string function_name =
    "AlgebraicEntirelyCollapsibleChannelMesh::bl_squash_fct_pt()\n";
 ...
 /// It does not make sense to specify the function pointer
 /// after the mesh has been set up!
 EntirelyCollapsibleChannelDomain::BLSquashFctPt& axial_spacing_fct_pt()
  {
   std::ostringstream error_message;
   error_message 
    ...
    << "algebraic remesh data when the algebraic mesh is first built. \n";
    std::string function_name =
     "AlgebraicEntirelyCollapsibleChannelMesh::axial_spacing_fct_pt()\n";
...
protected:
 ...
 EntirelyCollapsibleChannelDomain::BLSquashFctPt Dummy_fct_pt;
...
//=====start_of_refineable_algebraic_entirely_collapsible_channel_mesh=====
/// Refineable version of the CollapsibleChannel mesh with
/// algebraic node update.
//=================================================================
template<class ELEMENT>
class RefineableAlgebraicEntirelyCollapsibleChannelMesh : 
  public RefineableQuadMesh<ELEMENT>,
  public virtual AlgebraicEntirelyCollapsibleChannelMesh<ELEMENT>
{ 
...
public: 
 ...
 /// GeomObject that defines the collapsible segment and pointer to 
 /// TimeStepper (defaults to the default timestepper, Steady). 
 RefineableAlgebraicEntirelyCollapsibleChannelMesh(
                                          // const unsigned& nup, 
                                          //  const unsigned& ncollapsible, 
                                          //  const unsigned& ndown, 
                                          //  const unsigned& ny, 
  ...
  EntirelyCollapsibleChannelMesh<ELEMENT>(
                                  ...
                                  u_wall_pt, b_wall_pt,
                                  time_stepper_pt),
  AlgebraicEntirelyCollapsibleChannelMesh<ELEMENT>(
                                           //  nup, ncollapsible, ndown, ny,
                                           // lup, lcollapsible, ldown, ly,
                                           // wall_pt,
                                           // time_stepper_pt
