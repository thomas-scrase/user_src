...
#ifndef OOMPH_MONODOMAIN_FLUX_ELEMENTS_HEADER
#define OOMPH_MONODOMAIN_FLUX_ELEMENTS_HEADER
...
class MonodomainFluxElement : public virtual FaceGeometry<ELEMENT>, 
...
public:
 ...
 /// x is a Vector! 
 typedef void (*MonodomainPrescribedFluxFctPt)
 ...
 MonodomainFluxElement(FiniteElement* const &bulk_el_pt, 
                               const int &face_index);


 ///\short  Broken empty constructor
 MonodomainFluxElement()
  {
   throw OomphLibError(
    "Don't call empty constructor for MonodomainFluxElement",
    OOMPH_CURRENT_FUNCTION,
    OOMPH_EXCEPTION_LOCATION);
  }

 /// Broken copy constructor
 MonodomainFluxElement(const MonodomainFluxElement& dummy) 
  { 
   BrokenCopy::broken_copy("MonodomainFluxElement");
  } 
 
 /// Broken assignment operator
 void operator=(const MonodomainFluxElement&) 
  {
   BrokenCopy::broken_assign("MonodomainFluxElement");
  }

 /// Access function for the prescribed-flux function pointer
 MonodomainPrescribedFluxFctPt& flux_fct_pt() {return Flux_fct_pt;}
 ...
 inline void fill_in_contribution_to_residuals(Vector<double> &residuals)
  {
   ...
   fill_in_generic_residual_contribution_monodomain_flux(
 ...
 inline void fill_in_contribution_to_jacobian(Vector<double> &residuals,
                                          DenseMatrix<double> &jacobian)
  {
   ...
   fill_in_generic_residual_contribution_monodomain_flux(residuals,jacobian,1);
  }
...
private:
 ...
 void fill_in_generic_residual_contribution_monodomain_flux(
  Vector<double> &residuals, DenseMatrix<double> &jacobian, 
  unsigned flag);
 
 
 /// Function pointer to the (global) prescribed-flux function
 MonodomainPrescribedFluxFctPt Flux_fct_pt;

 /// The spatial dimension of the problem
 unsigned Dim;

 /// The index at which the unknown is stored at the nodes
 unsigned U_index_monodomain;
...
{  
 ...
 //Set up U_index_monodomain. Initialise to zero, which probably won't change
 //in most cases, oh well, the price we pay for generality
 U_index_monodomain = 0;
 ...
 switch(Dim)
  ...
  case 1:
  {
   MonodomainEquations<1>* eqn_pt = 
    dynamic_cast<MonodomainEquations<1>*>(bulk_el_pt);
   //If the cast has failed die
   if(eqn_pt==0)
    {
     std::string error_string =
      "Bulk element must inherit from MonodomainEquations.";
     error_string += 
      "Nodes are one dimensional, but cannot cast the bulk element to\n";
     error_string += "MonodomainEquations<1>\n.";
     error_string += 
   ...
   //Otherwise read out the value
   else
    {
     ...
     U_index_monodomain = eqn_pt->vm_index_BaseCellMembranePotential();
    }
  }
  break;
  ...
  case 2:
  {
   MonodomainEquations<2>* eqn_pt = 
    dynamic_cast<MonodomainEquations<2>*>(bulk_el_pt);
   //If the cast has failed die
   if(eqn_pt==0)
    {
     std::string error_string =
     ...
     error_string += "MonodomainEquations<2>\n.";
     error_string += 
      "If you desire this functionality, you must implement it yourself\n";
  ...
  case 3:
  {
   MonodomainEquations<3>* eqn_pt = 
    dynamic_cast<MonodomainEquations<3>*>(bulk_el_pt);
   //If the cast has failed die
   if(eqn_pt==0)
    {
     std::string error_string =
     ...
     error_string += "MonodomainEquations<3>\n.";
     error_string += 
      "If you desire this functionality, you must implement it yourself\n";
...
//===========================================================================
template<class ELEMENT>
void MonodomainFluxElement<ELEMENT>::
fill_in_generic_residual_contribution_monodomain_flux(
 ...
 unsigned flag)
{
 ...
 const unsigned u_index_monodomain = U_index_monodomain;
   ...
   for(unsigned l=0;l<n_node;l++)
    {
     ...
     local_eqn = nodal_local_eqn(l,u_index_monodomain);
