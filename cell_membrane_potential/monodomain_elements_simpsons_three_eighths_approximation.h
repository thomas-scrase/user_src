...
//IMPLEMENTS TOMS SIMPSONS SINGLE STEP FORMULATION OF DIFFUSION EQUATION,
// TAKES THE VM PREDICTED BY CELL SOLVE AS THE INITIAL POINT AND FORMULATES
// SIMPSONS APPROXIMATION OF THE INTEGRAL OF THE FUNCTION OVER THE
// TIME INTERVAL GIVEN BY DT. SIMPSONS 3/8THS RULE.
// APPROXIMATES INTERIOR POINTS OF INTERVAL USING CUBIC SPLINE, COULD USE QUINTIC IF NEED BE.
//THIS METHOD IS PROBABLY STABLE BECAUSE IT IS IMPLICIT
//3RD ORDER ACCURACY, BUMPED UP TO 5TH ORDER IF A QUINTIC SPLINE INTERPOLATION
// IS USED.
...
#ifndef OOMPH_MONODOMAIN_SIMPSONS_THREE_EIGHTHS_APPROXIMATION
#define OOMPH_MONODOMAIN_SIMPSONS_THREE_EIGHTHS_APPROXIMATION
...
class MonodomainEquationsSimpsonsThreeEighthsApproximation :
...
public:
	...
	typedef void (*MonodomainEquationsSimpsonsThreeEighthsApproximationDiffFctPt)
	(const Vector<double> &x, DenseMatrix<double> &D);

	//change this to take s instead of x? (no functional change, just notation)
	/// \short Funciton pointer to a diffusivity function
	typedef void (*MonodomainEquationsSimpsonsThreeEighthsApproximationDivDiffFctPt)
	(const Vector<double> &x, Vector<double> &D);


    MonodomainEquationsSimpsonsThreeEighthsApproximation()	:	Diff_fct_pt(0), Div_diff_fct_pt(0)
    {
    	this->disable_ALE();
    }
	...
	DenseMatrix<double> &mass_matrix, unsigned flag)
	{
		...
		for(unsigned ipt=0;ipt<n_intpt;ipt++)
		{
			...
			if (!this->ALE_is_disabled)
			{
				...
				// 	}
				// }
				throw OomphLibError("Monodomain elements with simpsons approximation are not implemented with ALE yet",
									OOMPH_CURRENT_FUNCTION,
									OOMPH_EXCEPTION_LOCATION);
			}
			...
			for(unsigned l=0;l<n_node;l++)
			{
				...
				if(local_eqn >= 0)
				{
					...
					residuals[local_eqn] += (dt/9.0)*tmp2*tmp3*W;
					...
					if(flag)
					{
						...
						{ 
							...
							if(local_unknown >= 0)
							{
								...
								jacobian(local_eqn, local_unknown) += (dt/9.0)*tmp2*tmp3*W;
							}
						}
					}
				}
	...
	MonodomainEquationsSimpsonsThreeEighthsApproximationDiffFctPt& diff_fct_pt() 
	{return Diff_fct_pt;}

	/// Access function: Pointer to diffusion function. Const version
	MonodomainEquationsSimpsonsThreeEighthsApproximationDiffFctPt diff_fct_pt() const 
	{return Diff_fct_pt;}


	/// Access function: Pointer to diffusion  function
	MonodomainEquationsSimpsonsThreeEighthsApproximationDivDiffFctPt& div_diff_fct_pt() 
	{return Div_diff_fct_pt;}

	/// Access function: Pointer to diffusion function. Const version
	MonodomainEquationsSimpsonsThreeEighthsApproximationDivDiffFctPt div_diff_fct_pt() const 
	{return Div_diff_fct_pt;}
...
//======================================================================
/// \short QMonodomainElementSimpsonsThreeEighthsApproximation elements are 
/// linear/quadrilateral/brick-shaped Advection Diffusion elements with 
/// isoparametric interpolation for the function.
//======================================================================
template <unsigned DIM, unsigned NNODE_1D>
 class QMonodomainElementSimpsonsThreeEighthsApproximation : 
 public virtual QElement<DIM,NNODE_1D>,
 public virtual MonodomainEquationsSimpsonsThreeEighthsApproximation<DIM>
{
...
private:
 ...
 QMonodomainElementSimpsonsThreeEighthsApproximation() : QElement<DIM,NNODE_1D>(), 
  MonodomainEquationsSimpsonsThreeEighthsApproximation<DIM>()
  { }

 /// Broken copy constructor
 QMonodomainElementSimpsonsThreeEighthsApproximation(
  const QMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D>&  dummy) 
  { 
   BrokenCopy::broken_copy("QMonodomainElementSimpsonsThreeEighthsApproximation");
  } 
 
 /// Broken assignment operator
 void operator=(const QMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D>&) 
  {
   BrokenCopy::broken_assign("QMonodomainElementSimpsonsThreeEighthsApproximation");
  }
...
//======================================================================
template<unsigned DIM, unsigned NNODE_1D>
double QMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D>::
...
//=======================================================================
/// \short Face geometry for the QMonodomainElementSimpsonsThreeEighthsApproximation elements: 
...
//=======================================================================
template<unsigned DIM, unsigned NNODE_1D>
class FaceGeometry<QMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D> >: 
...
class FaceGeometry<QMonodomainElementSimpsonsThreeEighthsApproximation<1,NNODE_1D> >: 
...
template<unsigned DIM, unsigned NNODE_1D>
class DiffAugmentedCell<QMonodomainElementSimpsonsThreeEighthsApproximation<DIM, NNODE_1D>>:
...
/////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
// TMonodomainElementSimpsonsThreeEighthsApproximation
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
...
//======================================================================
/// \short TMonodomainElementSimpsonsThreeEighthsApproximation elements are isoparametric triangular 
/// DIM-dimensional General Advection Diffusion Equations with  NNODE_1D nodal points along each
/// element edge. Inherits from TElement and MonodomainEquationsSimpsonsThreeEighthsApproximation
//======================================================================
template <unsigned DIM, unsigned NNODE_1D>
 class TMonodomainElementSimpsonsThreeEighthsApproximation : 
...
private:
 ...
 /// Advection Diffusion equations
 TMonodomainElementSimpsonsThreeEighthsApproximation() : TElement<DIM,NNODE_1D>(), 
  MonodomainEquationsSimpsonsThreeEighthsApproximation<DIM>()
  { }

 /// Broken copy constructor
 TMonodomainElementSimpsonsThreeEighthsApproximation(
  const TMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D>&  dummy) 
  { 
   BrokenCopy::broken_copy("TMonodomainElementSimpsonsThreeEighthsApproximation");
  } 
 
 /// Broken assignment operator
 void operator=(const TMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D>&) 
  {
   BrokenCopy::broken_assign("TMonodomainElementSimpsonsThreeEighthsApproximation");
  }
...
//======================================================================
template<unsigned DIM, unsigned NNODE_1D>
double TMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D>::
 dshape_and_dtest_eulerian_BaseCellMembranePotential(const Vector<double> &s,
                                         Shape &psi, 
                                         DShape &dpsidx,
                                         Shape &test, 
...
//=======================================================================
/// \short Face geometry for the TMonodomainElementSimpsonsThreeEighthsApproximation elements: 
/// The spatial dimension of the face elements is one lower than that 
/// of the bulk element but they have the same number of points along 
/// their 1D edges.
//=======================================================================
template<unsigned DIM, unsigned NNODE_1D>
class FaceGeometry<TMonodomainElementSimpsonsThreeEighthsApproximation<DIM,NNODE_1D> >: 
...
//=======================================================================
/// Face geometry for the 1D TMonodomainElementSimpsonsThreeEighthsApproximation: Point elements
//=======================================================================
template<unsigned NNODE_1D>
class FaceGeometry<TMonodomainElementSimpsonsThreeEighthsApproximation<1,NNODE_1D> >: 
 public virtual PointElement
{
...
//Override functions in specific implementations of the diff augmented wrapper
template<unsigned DIM, unsigned NNODE_1D>
class DiffAugmentedCell<TMonodomainElementSimpsonsThreeEighthsApproximation<DIM, NNODE_1D>>:
	public TMonodomainElement<DIM, NNODE_1D>
{
public:
