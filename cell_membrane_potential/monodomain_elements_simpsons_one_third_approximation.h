...
// TIME INTERVAL GIVEN BY DT. SIMPSONS 1/3RD RULE.
...
#ifndef OOMPH_MONODOMAIN_SIMPSONS_ONE_THIRD_APPROXIMATION
#define OOMPH_MONODOMAIN_SIMPSONS_ONE_THIRD_APPROXIMATION
...
class MonodomainEquationsSimpsonsOneThirdApproximation :
...
public:
	...
	typedef void (*MonodomainEquationsSimpsonsOneThirdApproximationDiffFctPt)
	(const Vector<double> &x, DenseMatrix<double> &D);

	//change this to take s instead of x? (no functional change, just notation)
	/// \short Funciton pointer to a diffusivity function
	typedef void (*MonodomainEquationsSimpsonsOneThirdApproximationDivDiffFctPt)
	(const Vector<double> &x, Vector<double> &D);


    MonodomainEquationsSimpsonsOneThirdApproximation()	:	Diff_fct_pt(0), Div_diff_fct_pt(0)
    {
    	this->disable_ALE();
    }
	...
	MonodomainEquationsSimpsonsOneThirdApproximationDiffFctPt& diff_fct_pt() 
	{return Diff_fct_pt;}

	/// Access function: Pointer to diffusion function. Const version
	MonodomainEquationsSimpsonsOneThirdApproximationDiffFctPt diff_fct_pt() const 
	{return Diff_fct_pt;}


	/// Access function: Pointer to diffusion  function
	MonodomainEquationsSimpsonsOneThirdApproximationDivDiffFctPt& div_diff_fct_pt() 
	{return Div_diff_fct_pt;}

	/// Access function: Pointer to diffusion function. Const version
	MonodomainEquationsSimpsonsOneThirdApproximationDivDiffFctPt div_diff_fct_pt() const 
	{return Div_diff_fct_pt;}
...
//======================================================================
/// \short QMonodomainElementSimpsonsOneThirdApproximation elements are 
/// linear/quadrilateral/brick-shaped Advection Diffusion elements with 
/// isoparametric interpolation for the function.
//======================================================================
template <unsigned DIM, unsigned NNODE_1D>
 class QMonodomainElementSimpsonsOneThirdApproximation : 
 public virtual QElement<DIM,NNODE_1D>,
 public virtual MonodomainEquationsSimpsonsOneThirdApproximation<DIM>
{
...
private:
 ...
 QMonodomainElementSimpsonsOneThirdApproximation() : QElement<DIM,NNODE_1D>(), 
  MonodomainEquationsSimpsonsOneThirdApproximation<DIM>()
  { }

 /// Broken copy constructor
 QMonodomainElementSimpsonsOneThirdApproximation(
  const QMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D>&  dummy) 
  { 
   BrokenCopy::broken_copy("QMonodomainElementSimpsonsOneThirdApproximation");
  } 
 
 /// Broken assignment operator
 void operator=(const QMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D>&) 
  {
   BrokenCopy::broken_assign("QMonodomainElementSimpsonsOneThirdApproximation");
  }
...
//======================================================================
template<unsigned DIM, unsigned NNODE_1D>
double QMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D>::
...
//=======================================================================
/// \short Face geometry for the QMonodomainElementSimpsonsOneThirdApproximation elements: 
...
//=======================================================================
template<unsigned DIM, unsigned NNODE_1D>
class FaceGeometry<QMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D> >: 
...
class FaceGeometry<QMonodomainElementSimpsonsOneThirdApproximation<1,NNODE_1D> >: 
...
template<unsigned DIM, unsigned NNODE_1D>
class DiffAugmentedCell<QMonodomainElementSimpsonsOneThirdApproximation<DIM, NNODE_1D>>:
...
/////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
// TMonodomainElementSimpsonsOneThirdApproximation
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
...
//======================================================================
/// \short TMonodomainElementSimpsonsOneThirdApproximation elements are isoparametric triangular 
/// DIM-dimensional General Advection Diffusion Equations with  NNODE_1D nodal points along each
/// element edge. Inherits from TElement and MonodomainEquationsSimpsonsOneThirdApproximation
//======================================================================
template <unsigned DIM, unsigned NNODE_1D>
 class TMonodomainElementSimpsonsOneThirdApproximation : 
...
private:
 ...
 /// Advection Diffusion equations
 TMonodomainElementSimpsonsOneThirdApproximation() : TElement<DIM,NNODE_1D>(), 
  MonodomainEquationsSimpsonsOneThirdApproximation<DIM>()
  { }

 /// Broken copy constructor
 TMonodomainElementSimpsonsOneThirdApproximation(
  const TMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D>&  dummy) 
  { 
   BrokenCopy::broken_copy("TMonodomainElementSimpsonsOneThirdApproximation");
  } 
 
 /// Broken assignment operator
 void operator=(const TMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D>&) 
  {
   BrokenCopy::broken_assign("TMonodomainElementSimpsonsOneThirdApproximation");
  }
...
//======================================================================
template<unsigned DIM, unsigned NNODE_1D>
double TMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D>::
 dshape_and_dtest_eulerian_BaseCellMembranePotential(const Vector<double> &s,
                                         Shape &psi, 
                                         DShape &dpsidx,
                                         Shape &test, 
...
//=======================================================================
/// \short Face geometry for the TMonodomainElementSimpsonsOneThirdApproximation elements: 
/// The spatial dimension of the face elements is one lower than that 
/// of the bulk element but they have the same number of points along 
/// their 1D edges.
//=======================================================================
template<unsigned DIM, unsigned NNODE_1D>
class FaceGeometry<TMonodomainElementSimpsonsOneThirdApproximation<DIM,NNODE_1D> >: 
...
//=======================================================================
/// Face geometry for the 1D TMonodomainElementSimpsonsOneThirdApproximation: Point elements
//=======================================================================
template<unsigned NNODE_1D>
class FaceGeometry<TMonodomainElementSimpsonsOneThirdApproximation<1,NNODE_1D> >: 
 public virtual PointElement
{
...
//Override functions in specific implementations of the diff augmented wrapper
template<unsigned DIM, unsigned NNODE_1D>
class DiffAugmentedCell<TMonodomainElementSimpsonsOneThirdApproximation<DIM, NNODE_1D>>:
	public TMonodomainElement<DIM, NNODE_1D>
{
public:
