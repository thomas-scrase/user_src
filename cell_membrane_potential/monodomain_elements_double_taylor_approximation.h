...
#ifndef OOMPH_MONODOMAIN_DOUBLE_TAYLOR_APPROXIMATION
#define OOMPH_MONODOMAIN_DOUBLE_TAYLOR_APPROXIMATION
...
class MonodomainEquationsDoubleTaylorApproximation :
...
public:
	...
	typedef void (*MonodomainEquationsDoubleTaylorApproximationDiffFctPt)
	(const Vector<double> &x, DenseMatrix<double> &D);

	//change this to take s instead of x? (no functional change, just notation)
	/// \short Funciton pointer to a diffusivity function
	typedef void (*MonodomainEquationsDoubleTaylorApproximationDivDiffFctPt)
	(const Vector<double> &x, Vector<double> &D);


    MonodomainEquationsDoubleTaylorApproximation()	:	Diff_fct_pt(0), Div_diff_fct_pt(0)
    {
    	this->disable_ALE();
    }
		...
		for(unsigned ipt=0;ipt<n_intpt;ipt++)
		{
			...
			for(unsigned l=0;l<n_node;l++)
			{
				...
				if(local_eqn >= 0)
				{
					...
					residuals[local_eqn] += (dt*dt/4.0)*tmp2*tmp3*W;
					...
					if(flag)
					{
						...
						{ 
							...
							if(local_unknown >= 0)
							{
								...
								jacobian(local_eqn, local_unknown) += (dt*dt/4.0)*tmp2*tmp3*W;
							}
						}
					}
				}
	...
	MonodomainEquationsDoubleTaylorApproximationDiffFctPt& diff_fct_pt() 
	{return Diff_fct_pt;}

	/// Access function: Pointer to diffusion function. Const version
	MonodomainEquationsDoubleTaylorApproximationDiffFctPt diff_fct_pt() const 
	{return Diff_fct_pt;}


	/// Access function: Pointer to diffusion  function
	MonodomainEquationsDoubleTaylorApproximationDivDiffFctPt& div_diff_fct_pt() 
	{return Div_diff_fct_pt;}

	/// Access function: Pointer to diffusion function. Const version
	MonodomainEquationsDoubleTaylorApproximationDivDiffFctPt div_diff_fct_pt() const 
	{return Div_diff_fct_pt;}
...
//======================================================================
/// \short QMonodomainElementDoubleTaylorApproximation elements are 
/// linear/quadrilateral/brick-shaped Advection Diffusion elements with 
/// isoparametric interpolation for the function.
//======================================================================
template <unsigned DIM, unsigned NNODE_1D>
 class QMonodomainElementDoubleTaylorApproximation : 
 public virtual QElement<DIM,NNODE_1D>,
 public virtual MonodomainEquationsDoubleTaylorApproximation<DIM>
{
...
private:
 ...
 QMonodomainElementDoubleTaylorApproximation() : QElement<DIM,NNODE_1D>(), 
  MonodomainEquationsDoubleTaylorApproximation<DIM>()
  { }

 /// Broken copy constructor
 QMonodomainElementDoubleTaylorApproximation(
  const QMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D>&  dummy) 
  { 
   BrokenCopy::broken_copy("QMonodomainElementDoubleTaylorApproximation");
  } 
 
 /// Broken assignment operator
 void operator=(const QMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D>&) 
  {
   BrokenCopy::broken_assign("QMonodomainElementDoubleTaylorApproximation");
  }
...
//======================================================================
template<unsigned DIM, unsigned NNODE_1D>
double QMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D>::
...
//=======================================================================
/// \short Face geometry for the QMonodomainElementDoubleTaylorApproximation elements: 
...
//=======================================================================
template<unsigned DIM, unsigned NNODE_1D>
class FaceGeometry<QMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D> >: 
...
class FaceGeometry<QMonodomainElementDoubleTaylorApproximation<1,NNODE_1D> >: 
...
template<unsigned DIM, unsigned NNODE_1D>
class DiffAugmentedCell<QMonodomainElementDoubleTaylorApproximation<DIM, NNODE_1D>>:
...
/////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////
// TMonodomainElementDoubleTaylorApproximation
////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////
...
//======================================================================
/// \short TMonodomainElementDoubleTaylorApproximation elements are isoparametric triangular 
/// DIM-dimensional General Advection Diffusion Equations with  NNODE_1D nodal points along each
/// element edge. Inherits from TElement and MonodomainEquationsDoubleTaylorApproximation
//======================================================================
template <unsigned DIM, unsigned NNODE_1D>
 class TMonodomainElementDoubleTaylorApproximation : 
...
private:
 ...
 /// Advection Diffusion equations
 TMonodomainElementDoubleTaylorApproximation() : TElement<DIM,NNODE_1D>(), 
  MonodomainEquationsDoubleTaylorApproximation<DIM>()
  { }

 /// Broken copy constructor
 TMonodomainElementDoubleTaylorApproximation(
  const TMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D>&  dummy) 
  { 
   BrokenCopy::broken_copy("TMonodomainElementDoubleTaylorApproximation");
  } 
 
 /// Broken assignment operator
 void operator=(const TMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D>&) 
  {
   BrokenCopy::broken_assign("TMonodomainElementDoubleTaylorApproximation");
  }
...
//======================================================================
template<unsigned DIM, unsigned NNODE_1D>
double TMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D>::
 dshape_and_dtest_eulerian_BaseCellMembranePotential(const Vector<double> &s,
                                         Shape &psi, 
                                         DShape &dpsidx,
                                         Shape &test, 
...
//=======================================================================
/// \short Face geometry for the TMonodomainElementDoubleTaylorApproximation elements: 
/// The spatial dimension of the face elements is one lower than that 
/// of the bulk element but they have the same number of points along 
/// their 1D edges.
//=======================================================================
template<unsigned DIM, unsigned NNODE_1D>
class FaceGeometry<TMonodomainElementDoubleTaylorApproximation<DIM,NNODE_1D> >: 
...
//=======================================================================
/// Face geometry for the 1D TMonodomainElementDoubleTaylorApproximation: Point elements
//=======================================================================
template<unsigned NNODE_1D>
class FaceGeometry<TMonodomainElementDoubleTaylorApproximation<1,NNODE_1D> >: 
 public virtual PointElement
{
...
//Override functions in specific implementations of the diff augmented wrapper
template<unsigned DIM, unsigned NNODE_1D>
class DiffAugmentedCell<TMonodomainElementDoubleTaylorApproximation<DIM, NNODE_1D>>:
	public TMonodomainElement<DIM, NNODE_1D>
{
public:
