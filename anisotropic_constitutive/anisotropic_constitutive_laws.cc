...
//===============================================================
bool AnisotropicConstitutiveLaw::is_matrix_square(const DenseMatrix<double> &M)
{
...
//========================================================================
bool AnisotropicConstitutiveLaw::are_matrices_of_equal_dimensions(
...
//=======================================================================
void AnisotropicConstitutiveLaw::error_checking_in_input(const DenseMatrix<double> &g, 
...
//===========================================================================
double AnisotropicConstitutiveLaw::
...
//===========================================================================
void AnisotropicConstitutiveLaw::
   ...
   for(unsigned j=i;j<dim;j++) 
    {
     ...
     // Get advanced stress
     this->calculate_second_piola_kirchhoff_stress(g,G_pls,A,V,sigma_pls);
   ...
   for (unsigned j=i;j<dim;j++)
    {
     ...
     this->calculate_second_piola_kirchhoff_stress(
      g,G_pls,A,V,sigma_dev_pls,Gup_pls,detG_pls);
   ...
   for (unsigned j=i;j<dim;j++)
    {
     ...
     // Get advanced stress
     this->calculate_second_piola_kirchhoff_stress(
      g,G_pls,A,V,sigma_dev_pls,Gup_pls,gen_dil_pls,inv_kappa_pls);
                                        ...
                                        double &inv_kappa)
{
 ...
 calculate_second_piola_kirchhoff_stress(g,G,A,V,sigma_dev,Gup,detG);
...
//Error checking
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 //ADD COMPUTE I_4 I_5 I_6 I_7 I_8
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 Anisotropic_strain_energy_function_pt->derivatives(I,A,V,dWdI);
